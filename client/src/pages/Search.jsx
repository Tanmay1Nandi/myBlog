      ...
      <div className="p-7 border-b md:border-r md:min-h-screen border-gray-500">
        <form className='flex flex-col gap-8' onSubmit={handleSubmit}>
            <div className="flex items-center gap-2">
                ...
                id='searchTerm' type='text' value={sidebarData.searchTerm}
                onChange={handleChange} />
            </div>
            <div className="flex items-center gap-2">
                <label className='font-semibold'>Sort:</label>
                <Select onChange={handleChange} value={sidebarData.order} id='order' className='w-22'>
            ...
            <div className="flex items-center gap-2">
                ...
                <Select onChange={handleChange} id='category' value={sidebarData.category} className='w-35'>
            ...
            <Button type='submit' className='bg-gradient-to-r from-purple-500 to-pink-500'>Apply Filters</Button>
        </form>
      </div>
