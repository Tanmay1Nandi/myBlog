    ...
    <div className='p-3 max-w-3xl mx-auto min-h-screen'>
        ...
        <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            ...
            <div className="flex gap-4 items-center justify-between border-4 border-teal-500 border-dotted p-3">
                ...
                <Button className='bg-gradient-to-r from-purple-500 to to-blue-500 py-5 text-gray-100 cursor-pointer sm:whitespace-nowrap' type="button" size='sm'
                 onClick={handleUploadImage}
                 disabled={imageUploadProgress}>
                    {imageUploadProgress ? <div className='w-10 h-10 text-red-600'>
                        <CircularProgressbar className="bg-gradient-to-r from-purple-500 to-blue-500 focus:ring-red-400" value={imageUploadProgress} text={`${imageUploadProgress || 0}%`} />
                    </div> :
                    "Upload Image"}
                </Button>
            </div>
